...
import {
  Globe, Camera, Video, Briefcase, MessageCircle,
  Mail, Phone, MapPin, Bot, Cpu, Building2,
  ArrowUpRight,
} from "lucide-react";
...
const socialLinks = [
  { title: "Facebook", href: "#", icon: Globe, color: "#818cf8" },
  { title: "Instagram", href: "#", icon: Camera, color: "#f472b6" },
  { title: "YouTube", href: "#", icon: Video, color: "#fb923c" },
  { title: "LinkedIn", href: "#", icon: Briefcase, color: "#38bdf8" },
  { title: "Twitter", href: "#", icon: MessageCircle, color: "#a5b4fc" },
];
...
export const Footer = () => {
  ...
  const footerLinkGroups: FooterLinkGroup[] = [
    {
      label: "Services",
      links: visibleServices.map(svc => ({ title: svc.title, href: "#services" })),
    },
    {
      label: "Brands",
      links: [
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background: `linear-gradient(90deg, transparent 0%, ${brand.color} 30%, #06d6a0 55%, #f472b6 80%, transparent 100%)`,
                boxShadow: `0 0 20px ${brand.color}44`,
              }}
            />
            ...
            <div aria-hidden className="absolute inset-0 pointer-events-none overflow-hidden">
              <div
                ...
                style={{
                  background: `radial-gradient(ellipse, ${brand.color}11 0%, transparent 70%)`,
                  filter: "blur(60px)",
                }}
              />
            </div>
            ...
            <div className="relative z-10 px-6 sm:px-10 pt-12 pb-6 flex flex-col gap-10 flex-1">
                ...
                <AnimatedContainer delay={0.05} className="w-full lg:max-w-sm shrink-0 space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      ...
                      style={{
                        background: `linear-gradient(135deg, ${brand.color}44, rgba(6,214,160,0.15))`,
                        border: `1px solid ${brand.color}66`,
                        boxShadow: "4px 4px 14px rgba(0,0,0,0.55), -2px -2px 8px rgba(255,255,255,0.04)",
                      }}
                    >
                      <img
                        src={brand.icon}
                    ...
                    <div>
                      ...
                      >
                        {activeCompany === "default" || activeCompany === "ajuedsolution" ? "LLP · Est. 2020" : "A Division of AJU ED Solutions"}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <a
                        ...
                        onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = brand.color; }}
                        onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "rgba(110,130,168,0.68)"; }}
                      >
                        <span style={{ color: `${brand.color}99` }}>{item.icon}</span>
                        {item.label}
                      </a>
                    ))}
                  </div>
                    ...
                    <AnimatedContainer key={group.label} delay={0.1 + index * 0.08}>
                      ...
                      >
                        <span
                          ...
                          style={{ background: `linear-gradient(90deg, ${brand.color}, #06d6a0)` }}
                        />
                        {group.label}
                      </h3>
              ...
              <AnimatedContainer delay={0.35}>
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${brand.color}15, rgba(6,214,160,0.06))`,
                ...
                >
                  ...
                  <a
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${brand.color}, #6366f1)`,
                      color: "#fff",
                      boxShadow: `0 4px 18px ${brand.color}44, 3px 3px 12px rgba(0,0,0,0.45), -1px -1px 6px rgba(255,255,255,0.04)`,
                    }}
                    onMouseEnter={(e) => {
                      const el = e.currentTarget as HTMLAnchorElement;
                      el.style.boxShadow = `0 8px 32px ${brand.color}77, 3px 3px 12px rgba(0,0,0,0.45), -1px -1px 6px rgba(255,255,255,0.04)`;
                      el.style.transform = "translateY(-2px)";
                    }}
                    onMouseLeave={(e) => {
                      const el = e.currentTarget as HTMLAnchorElement;
                      el.style.boxShadow = `0 4px 18px ${brand.color}44, 3px 3px 12px rgba(0,0,0,0.45), -1px -1px 6px rgba(255,255,255,0.04)`;
                      el.style.transform = "translateY(0)";
                    }}
                  >
