      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-4">
            <h1 className="text-5xl font-black tracking-tighter">INTERNSHIP DASHBOARD</h1>
            <div className="flex flex-wrap gap-4">
              <div className="relative group">
                ...
                <input 
                  ...
                  className="bg-zinc-900/50 border border-white/5 py-3 pl-12 pr-6 rounded-2xl text-sm focus:outline-none focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 transition-all w-64 md:w-80"
                  value={searchTerm}
              ...
              <div className="relative group">
                ...
                <select 
                  className="bg-zinc-900/50 border border-white/5 py-3 pl-12 pr-10 rounded-2xl text-sm focus:outline-none focus:border-indigo-500/50 appearance-none cursor-pointer"
                  value={filterTrack}
          ...
          <div className="bg-zinc-900/50 border border-white/5 py-4 px-8 rounded-2xl flex items-center gap-6">
            <div className="text-right">
              <div className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Showing</div>
              <div className="text-2xl font-black text-white">{filteredRegistrations.length} <span className="text-zinc-600 text-sm font-medium">/ {registrations.length}</span></div>
            </div>
          </div>
        </header>
        ...
        <div className="bg-zinc-950/40 backdrop-blur-3xl border border-white/5 rounded-[3rem] overflow-hidden shadow-2xl">
          ...
          <div className="bg-zinc-950 border border-white/10 rounded-[2.5rem] w-full max-w-xl overflow-hidden shadow-2xl relative">
            ...
            <form onSubmit={handleUpdate} className="p-10 md:p-12 space-y-8">
              <div className="space-y-1">
                <h2 className="text-3xl font-black tracking-tighter uppercase">Edit Registration</h2>
                <p className="text-zinc-500 text-sm font-medium">Update student details for {editingReg.registration_id}</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" 
                    className="w-full bg-zinc-900 border border-white/5 rounded-2xl p-4 text-sm focus:outline-none focus:border-indigo-500/50"
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    className="w-full bg-zinc-900 border border-white/5 rounded-2xl p-4 text-sm focus:outline-none focus:border-indigo-500/50 appearance-none"
              ...
              <div className="pt-4 flex gap-4">
                <button 
                  type="submit"
                  className="flex-1 bg-white text-black font-black py-5 rounded-3xl hover:bg-indigo-400 hover:text-white transition-all uppercase tracking-tighter text-lg shadow-xl"
                >
                  Save Changes
                </button>
                <button 
                  type="button"
                  onClick={() => setEditingReg(null)}
                  className="px-8 bg-zinc-900 border border-white/5 text-zinc-400 font-bold rounded-3xl hover:bg-zinc-800 transition-all uppercase text-sm"
                >
                  Cancel
                </button>
              </div>
