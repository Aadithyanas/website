        ...
        <div className="grid md:grid-cols-3 gap-6 w-full text-center">
          {pillars.map((item) => (
            <motion.div
              ...
              onHoverStart={(e) => {
                (e.target as HTMLElement).style.boxShadow = `0 8px 32px ${item.glowColor}, 0 0 0 1px ${item.borderColor}`;
              }}
              onHoverEnd={(e) => {
            ...
            >
              ...
              {/* Label */}
              <h3
                className={`text-xs font-mono tracking-[0.22em] uppercase ${item.textColor}`}
              >
                {item.label}
              </h3>
