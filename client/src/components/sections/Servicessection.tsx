...
const GlowingEffect = memo(({
  ...
  const gradient = variant === "white"
    ...
    : `radial-gradient(circle, #6366f1 10%, #6366f100 20%),
       ...
       radial-gradient(circle at 40% 60%, #a5b4fc 10%, #a5b4fc00 20%),
       repeating-conic-gradient(from 236.84deg at 50% 50%,
         #6366f1 0%, #818cf8 calc(25%/5), #06d6a0 calc(50%/5),
         #a5b4fc calc(75%/5), #6366f1 calc(100%/5))`;
      ...
      >
        <div className="relative h-40 w-full shrink-0 overflow-hidden">
          ...
          <div
            ...
            style={{ background: "linear-gradient(to bottom, transparent, rgba(20,25,41,0.6), #141929)" }}
          />
        </div>
        <div className="flex flex-1 flex-col justify-between gap-3 p-5">
          <div className="flex items-start gap-3">
            <div
              ...
              style={{
                ...
                color: "#818cf8",
                /* Neumorphic inset on icon box */
                boxShadow: "inset 2px 2px 6px rgba(0,0,0,0.38), inset -1px -1px 4px rgba(255,255,255,0.04)",
              }}
            >
              {icon}
            </div>
          ...
          <p className="text-sm leading-relaxed" style={{ color: "rgba(176,190,220,0.75)" }}>
            {description}
          </p>
        </div>
      </div>
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <h2
              className="font-mono tracking-widest uppercase mb-4 text-sm"
            ...
            {activeCompany !== "default" && (
              <div
                className="inline-flex items-center gap-2 mt-4 px-4 py-1.5 rounded-full border text-sm font-medium"
                style={{
                  borderColor: "rgba(99,102,241,0.2)",
                  background: "rgba(99,102,241,0.07)",
                  color: meta.color,
                  boxShadow: "inset 2px 2px 6px rgba(0,0,0,0.3), inset -1px -1px 4px rgba(255,255,255,0.04)",
                }}
              >
                {meta.icon}
                {meta.label}
                <span className="text-xs ml-1" style={{ color: "rgba(110,130,168,0.7)" }}>
        ...
        {visibleServices.length === 0 && (
          <div className="text-center py-24" style={{ color: "rgba(110,130,168,0.6)" }}>
